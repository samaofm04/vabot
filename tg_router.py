...
_OCR_PROMPT_FULL = (
    ...
    "l'ordre d'apparition, AVEC les emojis.\n"
    "RÈGLE ABSOLUE sur la mise en forme : à l'INTÉRIEUR de chaque bloc, reproduis "
    "EXACTEMENT les sauts de ligne visibles à l'écran. Mets un vrai retour à la "
    "ligne à CHAQUE endroit où le texte passe à la ligne suivante sur la vidéo. "
    "NE recolle JAMAIS plusieurs lignes en une seule phrase — même si ça coupe "
