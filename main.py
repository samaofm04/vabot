...
MAIN_COGS = ["welcome", "onboarding", "autopost", "general", "user", "cta_reminder", "noctustest", "clickrecap", "vaactivity", "sheetssync", "vasort", "tgrouter", "numeros", "telechargement", "noctuspool"]
