...
try:
    ...
    # Forme du 31/08 : {1:5, 2:5, 3:5, 4:5} — le panneau est PLEIN. Le menu
    # deroulant de la quantite occupe la rangee 0 a lui seul (un select prend
    # une RANGEE entiere, soit cinq places de bouton) : il reste donc vingt
    # places, et le ⭐⭐⭐ Trends a pris la derniere libre.
    #
    # C est la REGLE qu on protege, pas les nombres : une rangee, une famille,
    # et aucune qui deborde les cinq places de Discord. Consequence a retenir :
    # toute action supplementaire devra en remplacer une, ou faire sauter le
    # menu deroulant au profit d un bouton.
